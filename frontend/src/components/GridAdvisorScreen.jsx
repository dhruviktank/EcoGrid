...
export default function GridAdvisorScreen({ forecastData, site }) {
  ...
  const curtailmentMw = topAlert.curtailment_mw || 102;
  const peakerMw = topAlert.peaker_backup_mw || 0;
  const leadTime = topAlert.lead_time_hours || 2;
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-slate-500">
                Model Run ID: <span className="font-mono text-slate-900 font-semibold">ENS-9941-K8</span>
              </span>
            </div>

            <h2 className="text-xl font-bold text-slate-900 tracking-tight mt-1">
              Curtailment + BESS Ingestion Dispatch for Zone-4 Congestion Relief
            </h2>
            <p className="text-xs text-slate-600 max-w-3xl leading-relaxed">
              Automated algorithmic recommendation calculated at 14:14:02 UTC. 500-kV transmission interlock detected high risk of thermal overload on Line 14-Alpha. Coordinated setpoint adjustments enforce immediate headroom stabilization without involuntary tripping.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4 border-t border-slate-100 mt-4">
            ...
            >
              <div className="flex items-center justify-between mb-1">
                <span className="text-[11px] uppercase font-bold text-cyan-700">Setpoint 01 · Wind Phase-2</span>
                <span className="material-symbols-outlined text-base text-cyan-600">air</span>
              </div>
              <div className="text-2xl font-bold tabular-nums text-cyan-700">-{curtailmentMw} MW</div>
              <div className="flex items-center justify-between text-slate-500 text-[11px] mt-1">
                <span className="text-cyan-800 font-semibold">Curtailed 22.0%</span>
                <span className="font-medium text-slate-700">Cap: 360 MW</span>
              </div>
            </div>
            ...
            >
              ...
              <div className="text-2xl font-bold tabular-nums text-emerald-600">+140 MW</div>
              <div className="flex items-center justify-between text-slate-500 text-[11px] mt-1">
                <span className="text-emerald-800 font-semibold">Soak Rate (88% Target)</span>
                <span className="font-medium text-slate-700">Dur: 3h 15m</span>
              </div>
            </div>
            ...
            >
              ...
              <div className="text-2xl font-bold tabular-nums text-slate-800">{peakerMw} MW</div>
              <div className="flex items-center justify-between text-slate-500 text-[11px] mt-1">
                <span>Thermal Gas Peaker #3</span>
        ...
        <div className="lg:col-span-4 bg-white p-6 rounded-xl shadow-sm border border-slate-200/80 flex flex-col justify-between">
          <div>
            ...
            <div className="mt-3 flex items-baseline gap-2">
              <span className="text-3xl font-extrabold tracking-tight text-emerald-600">94.8%</span>
          ...
          <div className="space-y-2.5 pt-3">
            ...
            <div className="flex flex-col gap-1">
              <div className="flex justify-between text-xs">
                ...
                <span className="font-bold text-cyan-700">96.0%</span>
              </div>
              <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                <div className="h-full rounded-full bg-cyan-500" style={{ width: '96%' }}></div>
              </div>
            </div>

            <div className="flex flex-col gap-1">
              <div className="flex justify-between text-xs">
                <span className="text-slate-600">NOAA High-Resolution Rapid Refresh (HRRR)</span>
                <span className="font-bold text-emerald-700">96.5%</span>
              </div>
              <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                <div className="h-full rounded-full bg-emerald-600" style={{ width: '96.5%' }}></div>
              </div>
            </div>

            <div className="flex flex-col gap-1">
              <div className="flex justify-between text-xs">
                <span className="text-slate-600">NCEP Global Forecast System (GFS)</span>
                <span className="font-bold text-blue-700">92.0%</span>
              </div>
              <div className="w-full bg-slate-100 h-2 rounded-full overflow-hidden">
                <div className="h-full rounded-full bg-blue-600" style={{ width: '92%' }}></div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-3 pt-2 bg-slate-50 p-2.5 rounded-lg flex items-center gap-2 border-l-4 border-emerald-500 text-xs text-slate-800">
            ...
            <span>Verified against Western Interconnection Phasor Measurement limits.</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200/80 flex items-center gap-3 border-l-4 border-emerald-500">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-xl font-bold text-emerald-700 tabular-nums">+$64,200</span>
              <span className="text-[11px] text-slate-500">est. CAISO tariff</span>
            </div>
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200/80 flex items-center gap-3 border-l-4 border-cyan-500">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-xl font-bold text-slate-900 tabular-nums">248 MWh</span>
              <span className="text-[11px] font-semibold text-cyan-700">Kinetic Spill</span>
            </div>
            <span className="text-xs text-slate-500">Minimized from 580 MWh baseline dump</span>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-xl shadow-sm border border-slate-200/80 flex items-center gap-3 border-l-4 border-emerald-600">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-baseline gap-1">
              <span className="text-xl font-bold text-emerald-700 tabular-nums">184 Tons</span>
          ...
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-slate-100 font-mono text-[11px]">
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-2 px-3 font-semibold text-slate-900">INV-CLUSTER-04</td>
                <td className="py-2 px-3 text-slate-500">DNP3 / 192.168.4.12:20000</td>
                <td className="py-2 px-3 text-cyan-800">SET_ACTIVE_POWER_LIMIT(360.0 MW)</td>
              ...
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-2 px-3 text-emerald-800">SET_CHARGE_SCHEDULE(+140.0 MW, 3.25h)</td>
              ...
              <tr className="hover:bg-slate-50">
                ...
                <td className="py-2 px-3 font-semibold text-slate-900">PEAKER-UNIT-03</td>
                <td className="py-2 px-3 text-slate-500">IEC-60870-5-104 / 10.40.2.8:2404</td>
                <td className="py-2 px-3 text-slate-700">SET_SPINNING_RESERVE_MODE(2h_STANDBY)</td>
